 ...
 * |  Z  |   X  |   C    |   V    |   B  |   N  |   M  |  ,<  |  .>  |  /?   |
 * `-----+------+--------+--------+------+------+------+------+------+-------'
 * | `   | Ctrl |Sh(かな) |Esc/Cmd | Tab  |Space | Enter| Bksp |      |Sh(英数)|
 * `-------------------------------------------------------------------------'
 */
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_universal(
    ...
    LALT_T(KC_GRAVE), KC_LCTL,  LSFT_T(KC_LNG1), LGUI_T(KC_ESCAPE),LT(1,KC_TAB),LT(2,KC_SPC),LT(1,KC_ENTER), LT(2,KC_BSPC),_______,_______,_______, RSFT_T(KC_LNG2)
  ),
  ...
  LAYOUT_universal(
    ...
    KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,          KC_EQL,  S(KC_EQL),  KC_BSLS,   KC_LBRC, KC_RBRC,
    KC_F6,    KC_F7,   KC_F8,   KC_F9,  KC_F10,          KC_MINUS,S(KC_MINUS),S(KC_BSLS),KC_QUOT, S(KC_QUOT),
    _______, _______, _______, _______, _______,_______,_______,_______,_______,_______,_______, KC_LNG1
  ),

  /* Layer 2 (Adjust)
   * ,-------------------------------------------------------------------------.
   * |CPI-1k|CPI-100|CPI+100 |CPI+1k| Shot | RGB  |Mode+ |Mode- |      |       |
   * |------+-------+--------+------+------+------+------+------+------+-------|
   * |  1   |   2   |   3    |   4  |   5  |  <-  |   v  |   ^  |  ->  |       |
   * |------+-------+--------+------+------|------+------+------+------+-------|
   * |  6   |   7   |   8    |   9  |   0  |Ctl<- |Ctl-> | PgUp | PgDn | Save  |
   * `------+-------+--------+------+------+------+------+------+------+-------'
   * |      | Reset |        | SCRL+| SCRL-|      |      |      |      |       |
   * `-------------------------------------------------------------------------'
   */
  LAYOUT_universal(
    CPI_D1K,CPI_D100, CPI_I100,CPI_I1K, LGUI(LSFT(KC_4)),  RGB_TOG,      RGB_MOD,        RGB_RMOD,_______, _______,
    KC_1,   KC_2,    KC_3,     KC_4,   KC_5,             KC_LEFT,      KC_DOWN,           KC_UP,KC_RIGHT, _______,
    KC_6,   KC_7,    KC_8,     KC_9,   KC_0,             LCTL(KC_LEFT),LCTL(KC_RIGHT),  KC_PGUP,KC_PGDN, KBC_SAVE,
    _______, KBC_RST, _______, SCRL_DVI, SCRL_DVD, _______,_______,_______,_______,_______, _______, _______
  ),
...
// 有効にしていない layer
   ...
   * |     |      |        |        |      |      |      |      |      |       |
   * |-----+------+--------+--------+------+------+------+------+------+-------|
   * |     |      | Btn2   | Scroll | Btn1 |      | Btn1 |Scroll| Btn2 |       |
   * |-----+------+--------+--------+------|------+------+------+------+-------|
   * |     |      |        |        |      |      |      |      |      |       |
   * `-----+------+--------+--------+------+------+------+------+------+-------'
   * |     |      |        |        |      |      |      |      |      |       |
